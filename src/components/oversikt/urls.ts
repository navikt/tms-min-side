import { getDevBaseUrl, getEnvironmentClientSide, isAnsattClientSide } from "@utils/client/environment.ts";
...
export const meldekortUrl = isAnsattClientSide ? meldekortAnsattUrl : MELDEKORT_URL[getEnvironmentClientSide()];
